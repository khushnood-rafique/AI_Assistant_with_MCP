members_dict = {"information_node": "Specialized agent to provide information related to the availability of doctors or any FAQs related to the hospital.", "booking_node": "Specialized agent to book, cancel or reschedule appointments."}

options = list(members_dict.keys())+['FINISH']

worker_info = "\n\n".join(f'WORKER: {worker} \n DESCRIPTION: {description}' for worker, description in members_dict.items()) + "\n\nWORKER: FINISH \n DESCRIPTION: If user query is answered, route to FINSIH"
